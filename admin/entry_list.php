...
<div id="page-wrapper">
  ...
  <!-- Page Heading -->
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">4월 이벤트 참여자 목록</h1>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
...
<?php
	...
	$buyer_list_query = "SELECT * FROM member_info WHERE 1 ".$where." Order by idx DESC LIMIT $mnv_f->page_start, $page_size";
...
?>
              <tr>
                ...
                <td><?php echo $buyer_info[$key]['mb_week']?></td>
