...
$media_query	= "SELECT family_media, COUNT( family_media ) media_cnt FROM ".$_gl['family_info_table']." WHERE 1 AND family_regdate LIKE '%".$todayDate."%' GROUP BY family_media";
...
while ($media_daily_data = mysqli_fetch_array($media_res))
{
    ...
    $pc_query		= "SELECT * FROM ".$_gl['family_info_table']." WHERE 1 AND family_regdate LIKE  '%".$todayDate."%' AND family_media='".$media_daily_data['family_media']."' AND family_gubun='PC' ";
    $pc_count		= mysqli_num_rows(mysqli_query($my_db, $pc_query));
    $mobile_query	= "SELECT * FROM ".$_gl['family_info_table']." WHERE 1 AND family_regdate LIKE  '%".$todayDate."%' AND family_media='".$media_daily_data['family_media']."' AND family_gubun='MOBILE'";
