...
switch ($_REQUEST['exec'])
{
    case "insert_member_info" :
        ...
        $query		= "INSERT INTO member_info5(mb_ipaddr, mb_name, mb_phone, mb_addr, mb_gubun, mb_media, mb_regdate) values('".$_SERVER['REMOTE_ADDR']."','".$mb_name."','".$mb_phone."','".$mb_addr."','".$gubun."','".$_SESSION['ss_media']."',now())";
